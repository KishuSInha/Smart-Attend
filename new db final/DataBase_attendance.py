...
if __name__ == "__main__":
    ...
    # (1) Register students from ZIP
    register_students_from_zip("final_images.zip")

    # (2) Import attendance from CSV (from Code1)
    # Example:
    # import_attendance_from_csv("Attendance_05-09-2025.csv")

    # (3) Mark absentees
    mark_absentees()

    # (4) View attendance
    data = view_attendance(datetime.now().strftime("%d-%m-%Y"))
    for row in data:
        print(row)